...
if not openai_api_key:
    st.markdown("""
        <div class="card" style="border-left: 4px solid #D92D20; background-color: #FEF3F2;">
            ...
            <p style="color:#B42318; margin:0;">Please configure your OpenAI API Key securely within the Advanced Settings Secrets box or provide it via the system control sidebar panel to activate the backend parsing layers.</p>
        </div>
    """, unsafe_allowed_unsafe_html=True)
else:
