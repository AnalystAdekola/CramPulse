...
if not openai_api_key:
    st.error("⚠️ **Authentication Token Required:** Please configure your OpenAI API Key inside the Streamlit Advanced Settings Secrets panel or input it via the sidebar control to initialize the background engine.")
else:
